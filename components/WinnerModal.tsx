...
const WinnerModal: React.FC<WinnerModalProps> = ({ winner, onClose, onRemoveWinner, totalParticipants = 0 }) => {
    ...
    const winChance = winner && totalParticipants > 0 
        ? ((winner.weight / totalParticipants) * 100).toFixed(1) 
        : null;
                ...
                <>
                    {showConfetti && (
                        <ReactConfetti 
                            ...
                            recycle={false} 
                            numberOfPieces={500}
                            colors={[winner.color, '#FFD700', '#FF6B6B', '#4ECDC4', '#9B59B6']}
                        />
                    )}
                    <motion.div
                        initial={{ opacity: 0 }}
                            ...
                            >
                                <div className="flex items-center justify-center gap-3 mb-2">
                                    ...
                                    <span 
                                        ...
                                        style={{ fontFamily: isRTL ? "'Vazirmatn', sans-serif" : 'inherit' }}
                                    >
                                        {winner.name}
                                    </span>
                                </div>
                                ...
                                >
                                    {copied ? (
                                        <>
                                            ...
                                            <span className="text-green-500">{isRTL ? 'کپی شد!' : 'Copied!'}</span>
                                        </>
                                    ) : (
                                        <>
                                            <Copy size={14} />
